 ...
 * @author luiz
 */
public class BuscaFilaCompleta implements Callable<String>, ExceptionListener {
    ...
    public BuscaFilaCompleta(String numC) {
        numCompra = numC;
    }        
    ...
    resposta = "false";
        try {
            ...
            queue = (Queue) initialContext.lookup("Completa");
